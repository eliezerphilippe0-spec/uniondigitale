...
2. Appliquer les migrations **dans l'ordre** (`supabase/migrations/`, **17 fichiers** `0001 → … → 0017`) :
   - le plus simple : **SQL Editor** → coller **tout `supabase/schema.sql`** (concaténation à jour des 17 migrations) → *Run* ;
